...
<form action="<?php echo base_url();?>empleados/insertarEmpleado" method='post'>
    ...
    <div class="form-group">
      ...
      <input style="font-size: 20px;" type="time" class="form-control" id="txthoraEntrada" placeholder="Insertar la hora de entrada" name="txthoraEntrada">
    </div>
     <div class="form-group">
      <label for="time" style="font-size: 20px;"><b>Hora de salida:</b></label>
      <input style="font-size: 20px;" type="time" class="form-control" id="txthoraSalida" placeholder="Insertar la hora de salida" name="txthoraSalida">
    </div>
     <div class="form-group">
    ...
    <button type="submit" style="font-size: 20px; opacity: 0.9; margin-bottom: 5%;" class="btn bg-danger text-white container-fluid"><b>Registrar empleado</b></span>
  </form>
</div>
</div>
