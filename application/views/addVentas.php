...
<div class="container bg-light border border-secondary" style="width:50%;margin-bottom: 8%; margin-top: 8%;">
  <h4 class="text-center bg-light" style="margin-top: 2%;" >INGRESE LA INFORMACIÓN DE LA VENTA</h4>
  <img class="mx-auto d-block" width="40%" src="<?php echo base_url();?>/assests/img/venta.png" alt="">
...
<form action="<?php echo base_url();?>menu/insertVenta" method='post'>
